...
已增加银河日线/15分/60分离线补数、跨周期回放和 55 战法人工训练预设。
MA55/MA233 沿用原自定义 MA 设置。安装、数据口径与使用步骤见 [55 战法训练指南](docs/55_TRAINING.md)。
...
| wx群聊 | 小红书群聊 |
| :---: | :---: |
| <img src="https://github.com/user-attachments/assets/3c546151-03e3-4bae-8825-d465945ce522" alt="WX QR Code" width="180"> |  |
